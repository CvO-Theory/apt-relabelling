 ...
 * Copyright (C) 2014-2018  Uli Schlachter
 *
 ...
 */
public class RationalSystemSolver {
	 ...
	 */
	public RationalSystemSolver assertDisjunction(InequalitySystem... disjunction) {
		int numVariables = 0;
	 ...
	 * @return This solver instance
	 */
	public RationalSystemSolver push() {
		script.push(1);
	 ...
	 * @return This solver instance
	 */
	public RationalSystemSolver pop() {
		script.pop(1);
